...
import addbook,addmember,givebook,returnbook,addpublisher
...
class Main(object):
    def __init__(self,master):
        ...
        def displayBooks(self):
            ...
            for book in books:
                ...
                def bookInfo(evt):
                    ...
                    if book_info[0][5] == None:
                        self.list_details.insert(4, "Publisher Name : Not Avaialable")
                    else:
                        self.list_details.insert(4, "Publisher Name : " + book_info[0][5])
                    if book_info[0][6] == 0:
        ...
        self.iconpublish = ImageTk.PhotoImage(file='icons/give_book.png')
        self.btnpublish = Button(topFrame, text='Add Publisher', font='arial 12 bold', padx=10,
                                image=self.iconreturn, compound=LEFT, command=self.addpublisher)
        self.btnpublish.pack(side=LEFT)
...
######################################Tabs#########################################
    ...
    def addpublisher(self):
        add_publisher = addpublisher.AddPublisher()
